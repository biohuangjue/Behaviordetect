...
# 加载 sleap 模型
predictor = sleap.load_model(["F:/guangyichuan/models/240727_145201.centroid.n=38.zip", "F:/guangyichuan/models/240727_150142.centered_instance.n=38.zip"], batch_size=10)  # 采用的 sleap 模型
...
def analyze_frames():
    ...
    cap = cv2.VideoCapture(r"C:\Users\A\Desktop\guangyichuan\videos\0702Sweet 5+5+5-1.mp4")  # 视频读取路径
